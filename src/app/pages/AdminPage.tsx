...
import { BarChart3, Calendar, Leaf, RefreshCw, Settings, Users, type LucideIcon } from 'lucide-react'
 ...
 */
const CARDS: { to: string; icon: LucideIcon; title: string; desc: string; key?: NavKey }[] = [
  {
    to: '/admin/overview',
    icon: BarChart3,
    title: 'Tổng quan',
